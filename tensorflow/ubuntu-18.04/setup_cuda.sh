...
CUDA_VERSION="9.2.148_396.37"
CUDNN_VERSION="7.2.1.38"

CUDNN_URL="https://developer.download.nvidia.com/compute/machine-learning/repos/ubuntu1604/x86_64/libcudnn7_${CUDNN_VERSION}-1+cuda${CUDA_VERSION}_amd64.deb"
CUDNN_URL_DEV="https://developer.download.nvidia.com/compute/machine-learning/repos/ubuntu1604/x86_64/libcudnn7-dev_${CUDNN_VERSION}-1+cuda${CUDA_VERSION}_amd64.deb"
